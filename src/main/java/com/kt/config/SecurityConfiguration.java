...
public class SecurityConfiguration {
	...
	private static final String[] GET_PERMIT_ALL = {"/api/health/**", "/swagger-ui/**", "/v3/api-docs/**", "/users/duplicate-login-id"};
	private static final String[] POST_PERMIT_ALL = {"/users", "/auth/login", "/api/v1/public/**"};
